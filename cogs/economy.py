...
class Economy:
    ...
    @eco.command(name='register', help='Register yourself in the bank!')
    ...
    @eco.command(name='balance', help='When you want to check how much PPD you have.')
    ...
    @eco.command(name='work', help='Work once a day to earn PPD the honest, hardworking way.')
